...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_averias, R.id.nav_talleres, R.id.nav_share, R.id.nav_logaut)
   ...
   /* @Override
    public boolean onOptionsItemSelected(MenuItem item){
        Toast.makeText(this, "Estas en el metodo", Toast.LENGTH_SHORT).show();
        Fragment f = null;
        int id = item.getItemId();
        if(id == R.id.nav_gallery){
            Toast.makeText(this, "Estas aqui en gallery", Toast.LENGTH_SHORT).show();
            f = new ListaTaleresFragment();
        }
